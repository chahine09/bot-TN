...
client.on("ready", () => {
  ...
  client.user.setActivity(`${prefix}help | TN-system`, { type: "WATCHING" });
});
...
client.on('message', message => {
  // Here is where you need to code
  if(message.content == "shit for you") {
    message.channel.send("تسب فيا متحشمش");
  }
});
...
client.on('message', message => {
  ...
  if(message.content == "$link") {
    message.channel.send("https://tnser.blogspot.com/");
  }
});

client.on('message', message => {
  // Here is where you need to code
  if(message.content == "سيستام") {
    message.channel.send("تضفل شحاشتك");
  }
});

client.on('message', message => {
  // Here is where you need to code
  if(message.content == "احسن بلد") {
    message.channel.send("TN توا هذا سوال بطبيعة ");
  }
});

client.on('message', message => {
  // Here is where you need to code
  if(message.content == "عوني ") {
    message.channel.send("اكتب $help ");
  }
});

client.on('message', message => {
  // Here is where you need to code
  if(message.content == "يا بوت عوني") {
    message.channel.send("تدلل");
  }
});
